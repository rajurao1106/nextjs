      ...
      >
        ...
        <div className="relative w-full max-w-[1200px] flex flex-col items-center ">
          <Image
            src={bg_image}
            alt="Background"
            className="w-full max-lg:h-[75vh] object-cover"
          />
          <Image
            src={outdoor_icon}
            alt="Background"
          ...
          <div className="absolute top-0 max-lg:-top-[3.5rem] z-0 w-full flex justify-center items-center flex-col">
            <h1
              className={`text-6xl w-[60%] max-lg:w-[90%] max-lg:text-[2rem] bg-gradient-to-r from-yellow-400 via-yellow-300 
              to-white bg-clip-text text-transparent text-white font-extrabold mt-24 mb-12 font-[Exo 2]`}
            >
              EXPERIENCE THE FUTURE OF BRANDING
            </h1>
            <p className="text-lg max-lg:text-base drop-shadow-[0_0_0.5px_black] text-white mt-4 w-[50%] max-lg:w-[80%] mx-auto">
