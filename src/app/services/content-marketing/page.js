...
import marketing from "../../../images/services/content-marketing/marketing.png";
import creative from "../../../images/services/content-marketing/creative.png";
import content from "../../../images/services/content-marketing/content.png";
import Image from "next/image";
import hero_image from '../../../images/services/content-marketing/hero_image.png';
      ...
      <section className="px-6 py-20 md:px-20 lg:px-32 bg-gradient-to-br from-blue-50 to-white">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            <h1 className="text-4xl md:text-5xl font-[Quicksand] font-extrabold leading-tight mb-6">
              Make Your Business with{" "}
              <span className="text-indigo-600">content Marketing</span>
            </h1>
