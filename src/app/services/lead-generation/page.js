...
import lead1 from "../../../images/services/lead-generation/lead1.png";
import lead2 from "../../../images/services/lead-generation/lead2.png";
import lead3 from "../../../images/services/lead-generation/lead3.png";
import Image from "next/image";
import hero_image from '../../../images/services/lead-generation/hero_image.png';
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            <h1 className="text-4xl md:text-6xl font-[Quicksand] font-extrabold leading-tight mb-6">
              ...
              <span className="text-blue-600">Lead Generation Marketing</span>
            </h1>
            <p className="text-lg mb-6 text-gray-700">
              We help brands like Slack, Microsoft, and Logitech grow with
              creative and strategic solutions.
            </p>
            <button className="px-6 py-3 rounded-xl text-white font-semibold bg-blue-600 hover:bg-blue-700 transition duration-300 shadow-md">
              Get Started
            </button>
